...
* In order for the program to work correctly it's necessary to start a scan or at least click the "Clean" button before managing (especially deleting) medias in the visualizer module.
